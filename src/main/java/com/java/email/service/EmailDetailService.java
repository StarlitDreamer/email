...
//    }
    ...
    public void generateEmailReport() {
        ...
        for (Map.Entry<String, Set<String>> entry : emailTaskIdMap.entrySet()) {
            ...
            EmailReport byEmailTaskId = emailReportRepository.findByEmailTaskId(emailTaskId);
            ...
            emailReport.setUnsubscribeAmount(byEmailTaskId.getUnsubscribeAmount());
            emailReport.setOpenAmount(byEmailTaskId.getOpenAmount());
